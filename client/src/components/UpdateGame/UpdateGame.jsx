...
import { updateGameCreated } from '../../redux/actions/index';
...
export default function UpdateGame() {
  ...
  function handlerAdd(event) {
    ...
    if(handlerValidate()) {
      ...
      dispatch(updateGameCreated(cache, gameData.id));
      setCheck(...check, 'The game was updated, Please Wait...');
      ...
      <>
        ...
        <div className='spaceCreateNew'>
          <div className={checkContainer?'formContainerValidate':'formContainer'}>
            <h1 className='formTitle'>UPDATE GAME</h1>
            <form onSubmit={(event) => handlerAdd(event)}>
              ...
              <button className={handlerValidate()?'btnForm':'btnFormDisabled'} type='submit' disabled={!handlerValidate()}>Update</button>
